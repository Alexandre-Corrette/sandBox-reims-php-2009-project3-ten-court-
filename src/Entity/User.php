...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=TennisCourt::class, mappedBy="owner")
     */
    private $tennisCourts;
    ...
    /**
     * @return Collection|TennisCourt[]
     */
    public function getTennisCourts(): Collection
    {
        return $this->tennisCourts;
    }

    public function addTennisCourt(TennisCourt $tennisCourt): self
    {
        if (!$this->tennisCourts->contains($tennisCourt)) {
            $this->tennisCourts[] = $tennisCourt;
            $tennisCourt->setOwner($this);
        }

        return $this;
    }

    public function removeTennisCourt(TennisCourt $tennisCourt): self
    {
        if ($this->tennisCourts->removeElement($tennisCourt)) {
            // set the owning side to null (unless already changed)
            if ($tennisCourt->getOwner() === $this) {
                $tennisCourt->setOwner(null);
            }
        }
